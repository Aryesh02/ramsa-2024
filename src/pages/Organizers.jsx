...
import Img1 from "../img/prevConf/2022-1.jpeg";
function Organizers() {
    return (
        <div className="mainstyle">
            ...
            <div className="style">
                <Box1
                    post="CHIEF PATRONS"
                    name1="Shri Jaiprakash Gaur Ji,"
                    position1="Founder Chancellor, JIIT"
                    name2="Shri Manoj Gaur Ji,"
                    position2="Executive Chairman, Jaypee Group"
                />
                <Box1
                    post="PATRONS"
                    name1="Prof. S. C. Saxena,"
                    position1="Pro Chancellor, JIIT"
                    name2="Prof. B. R. Mehta,"
                    position2="Vice Chancellor, JIIT"
                />
            </div>
            <br />
            <br />
            <Box2
                ...
                name1="Prof. Alka Tripathi,"
                position1="Head, Department of Mathematics"
            />
            <Box2
                post="CONVENERS"
                name1="Dr. Pankaj K. Srivastava & Dr. Dinesh C. S. Bisht"
                position1="Associate Professor(s)"
            />
            <br />
            <br />
            <div className="style2">
                ...
                <div className="style">
                    ...
                    <Box3
                        post="FINANCE CHAIR"
                        name1="Dr. Anuj Bhardwaj"
                        position1="Associate Professor"
                    />
                    <div className="style-special2"></div>
                    <Box3
                        post="HOSPITALITY CHAIR"
                        name1="Dr.  Himanshu Agarwal"
                        position1="Assistant Professor"
                    />
                </div>
                <div className="style">
                    <Box3
                        post="PUBLICITY & BROADCAST CHAIR"
                        name1="Dr. Amita Bhagat"
                        position1="Assistant Professor"
                    />
                    <div className="style-special"></div>
                    <Box3
                        post="REGISTRATION CHAIR"
                        name1="Dr. Richa Sharma"
                        position1="Assistant Professor"
